                                        ...
                                        <div class="card text-black bg-transparent bg-success mb-3" style="max-width: 30rem;">
                                            @foreach ($data1 as $data1)
                                                <div class="card-header">
                                                    ...
                                                    <input type="text" value = "{{ $data1->nombre_completo }}"  id="nombre" name="nombre" readonly> <br>
                                                    <label><b>NÚMERO DE C.I.:</b></label> 
                                                    <input type="text" value= {{ $data1->ci }} id="ci" name="ci" readonly>
                                                    <label><b>NÚMERO DE PROSPECTO:</b></label>
